...
def search(name: str) -> list:
    ...
    CC = {'cc', 'スカイガーデン', 'すかいがーでん', 'スカガ', 'すかが', '空中花園'}
    ...
    rMMM = {'rmmm', 'mmm' 'モーモーカントリー', 'もーもーカントリー', 'モモカン', 'ももかん', 'もーもーかんとりー', '牛', 'うし', '牛牛農場'}
    ...
    rGV = {'rgv', 'gv', 'グラグラ', 'ぐらぐら', 'グラグラ火山', 'ぐらぐら火山', 'グラグラカザン', 'ぐらぐらかざん', '火山', 'かざん', '震震火山'}
    ...
    bSG = {'bsg', 'sg', 'gbaスカイガーデン',  'gbaすかいがーでん', 'gbaスカガ', 'gbaすかが', 'グバスカ', 'ぐばすか', 'グバガ', 'ぐばが', 'gba空中花園'}
    ...
    bDCt = {'bdct', 'dct', 'デイジーサーキット', 'デイサ', 'でいさ'}
    bPPC = {'bppc', 'ppc', 'パックンしんでん', 'パクしん', 'ぱくしん', 'しんでん'}
